...
function[Q]=non_absorbing_t_matrix(s,p,q_r,q_w,a_r,b_r,a_w,b_w)


%%% Function for transition matrix for reversible (non-absorbing) Markov
%%% chain

%%% ==== Input =====%%%

% s= state matrix (s=s_matrix(n,E_position))
